...
export default function Home() {
  ...
  return (
    <>
          ...
          {usuario && token ? (
            <div className="nav-usuario" id="nav-usuario">
              <div className="nav-user-info">
                ...
                <div className="nav-user-rol" id="nav-rol">{roles[usuario.rol] || usuario.rol}</div>
              </div>
      ...
      {/* El main ya no tiene padding-top, el espacio lo da .hero */}
      <main style={{ background: 'var(--crema)' }}>
              ...
              <section className="hero">
                ...
                <svg className="hero-maiz-deco" viewBox="0 0 120 200" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <ellipse cx="46" cy="108" rx="4" ry="5" fill="#E8A020"/>
                  <ellipse cx="54" cy="106" rx="4" ry="5" fill="#F0B429"/>
                  <ellipse cx="62" cy="106" rx="4" ry="5" fill="#F2C040"/>
                  <ellipse cx="70" cy="106" rx="4" ry="5" fill="#E8A020"/>
                  <ellipse cx="78" cy="108" rx="4" ry="5" fill="#F0B429"/>
                ...
                <div className="avances-grid">
                  <div className="reveal">
                    <div className="avance-item">
                      ...
                      <div>
                        <div className="avance-titulo">Diseño de la base de datos</div>
                        <div className="avance-desc">Arquitectura PostgreSQL/PostGIS con 7 esquemas y 40+ tablas.</div>
                        <span className="avance-badge badge-completado">Completado</span>
                      </div>
                    </div>
                    <div className="avance-item">
                      <div className="avance-fecha">MES 2</div>
                      <div>
                        <div className="avance-titulo">Catálogos territoriales</div>
                        <div className="avance-desc">Estados, municipios, comunidades, localidades y lenguas originarias cargados.</div>
                        <span className="avance-badge badge-completado">Completado</span>
                      </div>
                    </div>
                    <div className="avance-item">
                      ...
                      <div>
                        <div className="avance-titulo">Módulos de captura</div>
                        <div className="avance-desc">Frontend completo para productores, catálogos y módulos social y cultural.</div>
                        <span className="avance-badge badge-en-curso">En curso</span>
                      </div>
                    </div>
                    <div className="avance-item">
                      <div className="avance-fecha">MES 4</div>
                      <div>
                        <div className="avance-titulo">Visitas de campo</div>
                        <div className="avance-desc">Levantamiento en 15+ comunidades con GPS y dron Mavic 3.</div>
                        <span className="avance-badge badge-en-curso">En curso</span>
                      </div>
                    </div>
                    <div className="avance-item">
                      ...
                      <div>
                        <div className="avance-titulo">Informe de diagnóstico</div>
                        <div className="avance-desc">Reporte socioterritorial y análisis preliminar de resultados de campo.</div>
                        <span className="avance-badge badge-proximo">Próximo</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="equipo-wrap" id="equipo">
                <div className="equipo-inner">
                  ...
                  <div className="equipo-grid">
                    <div className="eq-card reveal" style={{ animationDelay: '.05s', borderColor: 'rgba(74,140,100,.3)', background: 'var(--verde-pal)' }}>
                      <div className="eq-inicial" style={{ background: 'var(--verde-cl)' }}>AB</div>
                      <div className="eq-nombre">Alfredo Barrón Rodríguez</div>
                      <div className="eq-esp" style={{ color: 'var(--verde-cl)' }}>Responsable técnico</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.1s' }}>
                      <div className="eq-inicial">SR</div>
                      <div className="eq-nombre">Sofía del Rosario Romero Ramos</div>
                      <div className="eq-esp">Industrias alimentarias</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.15s' }}>
                      <div className="eq-inicial">HL</div>
                      <div className="eq-nombre">Hugo René Larraga Altamirano</div>
                      <div className="eq-esp">Sistemas computacionales</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.2s' }}>
                      <div className="eq-inicial">DP</div>
                      <div className="eq-nombre">Daniel Perales Rosas</div>
                      <div className="eq-esp">Parasitología agrícola</div>
                      <span className="eq-sni">SNI Nivel I</span>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.25s' }}>
                      <div className="eq-inicial">DH</div>
                      <div className="eq-nombre">Dalia Rosario Hernández López</div>
                      <div className="eq-esp">Sistemas computacionales</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.3s' }}>
                      <div className="eq-inicial">OE</div>
                      <div className="eq-nombre">Omar Espinosa Guerra</div>
                      <div className="eq-esp">Electrónica y software</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.35s' }}>
                      <div className="eq-inicial">RJ</div>
                      <div className="eq-nombre">Rosa María Jiménez Maldonado</div>
                      <div className="eq-esp">Emprendimiento comunitario</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.4s' }}>
                      <div className="eq-inicial">CG</div>
                      <div className="eq-nombre">Carlos Cecilio Góngora Canul</div>
                      <div className="eq-esp">Fitopatología</div>
                      <span className="eq-sni">SNI Nivel I</span>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.45s' }}>
                      <div className="eq-inicial">HM</div>
                      <div className="eq-nombre">Habacuc Lorenzo Márquez</div>
                      <div className="eq-esp">SIG y análisis estadístico</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.5s' }}>
                      <div className="eq-inicial">DA</div>
                      <div className="eq-nombre">Dulce Carolina Acosta Pintor</div>
                      <div className="eq-esp">Desarrollo sustentable</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.55s' }}>
                      <div className="eq-inicial">AP</div>
                      <div className="eq-nombre">Ana María Piedad Rubio</div>
                      <div className="eq-esp">Sistemas computacionales</div>
                    </div>
                    <div className="eq-card reveal" style={{ animationDelay: '.6s' }}>
                      <div className="eq-inicial">CW</div>
                      <div className="eq-nombre">Cynthia Wong Arguelles</div>
                      <div className="eq-esp">Ciencias ambientales</div>
                      <span className="eq-sni">SNI Nivel I</span>
                    </div>
                  </div>
                </div>
