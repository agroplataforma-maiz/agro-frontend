        ...
        <div className="equipo-wrap" id="equipo">
            <div className="equipo-inner">
                ...
                <div className="equipo-grid">
                    ...
                    <div className="eq-card reveal" style={{ animationDelay: '.2s' }}><div className="eq-inicial">DP</div><div className="eq-nombre">Daniel Perales Rosas</div><div className="eq-esp">Parasitología agrícola</div><span className="eq-sni">SNII Nivel C</span></div>
                    ...
                    <div className="eq-card reveal" style={{ animationDelay: '.4s' }}><div className="eq-inicial">CG</div><div className="eq-nombre">Carlos Cecilio Góngora Canul</div><div className="eq-esp">Fitopatología</div><span className="eq-sni">SNII Nivel I</span></div>
                    ...
                    <div className="eq-card reveal" style={{ animationDelay: '.5s' }}><div className="eq-inicial">DA</div><div className="eq-nombre">Dulce Carolina Acosta Pintor</div><div className="eq-esp">Desarrollo sustentable</div><span className="eq-sni">SNII Nivel I</span></div>
                    ...
                    <div className="eq-card reveal" style={{ animationDelay: '.6s' }}><div className="eq-inicial">CW</div><div className="eq-nombre">Cynthia Wong Arguelles</div><div className="eq-esp">Ciencias ambientales</div><span className="eq-sni">SNII Nivel I</span></div>
                </div>
            </div>
        </div>
    );
